...
public abstract class GameObject {
  ...
  private final int myBlueprintID;
  ...
  private final SpriteData mySpriteData;
  private final Map<String, FrameData> myFrameMap;
  private final Map<String, AnimationData> myAnimationMap;
  private final Map<String, String> myParams;
  private List<Event> myEvents;
  private final HitBoxData myHitBoxData;
