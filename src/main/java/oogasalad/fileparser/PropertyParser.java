...
/**
 * The {@code PropertyParser} class is responsible for parsing XML elements that represent properties.
 * It provides public methods to parse both double and string properties contained in designated XML nodes.
 * <p>
 * By default, property children are expected to have the tag name "data". However, overloaded methods
 * allow clients to specify an alternative child tag (for example, "property" when using the format
...
public class PropertyParser {
  ...
  /**
   * Parses the XML element containing property data into a map whose values
   ...
   *                          or "stringProperties").
   * @param childTag          the tag name of the child elements holding property data.
   * @param converter         a {@link Function} to convert property values from {@code String}
   *                          to the desired type.
  ...
  /**
   * Processes all child nodes of the given properties element and returns a map of property
   * names to their converted values.
   *
   * @param <T>               the type of the property value.
  ...
  /**
   * Processes a single property element by extracting its name and value,
   * converting the value using the provided converter, and placing it into the properties map.
   * <p>
