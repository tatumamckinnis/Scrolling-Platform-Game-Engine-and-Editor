...
class DefaultEngineFileTest {
  ...
  void setUp() {
    ...
    SpriteData spriteData1 = new SpriteData("Mario",
        new FrameData("Mario Paused", 1, 1, 2, 4, new File("dd")), new ArrayList<>(),
        new ArrayList<>());
    HitBoxData hitBoxData1 = new HitBoxData("Mario", 1, 1, 2, 4);
    bluePrintMap.put(1, new BlueprintData(1, "Mario", "Player", "Player", spriteData1, hitBoxData1,
    ...
    levelData = new LevelData("Super Mario Bros", 500, 500, bluePrintMap, gameObjectsByLayer);
  }
  ...
  void loadFileToEngine() {
    ...
    expectedObjects.add(
        new Entity(uuid, "Player", 1, 1.0, 5.0, expectedHitBox, expectedSprite, events,
