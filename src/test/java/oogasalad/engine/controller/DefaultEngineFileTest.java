...
class DefaultEngineFileTest {
  ...
  void loadFileToEngine()
    ...
    assertEquals(expectedObjects.getFirst().getName(), actualObjects.getFirst().getName());
    assertEquals(expectedObjects.getFirst().getGroup(), actualObjects.getFirst().getGroup());
    assertEquals(expectedObjects.getFirst().getSpriteData(), actualObjects.getFirst().getSpriteData());
    assertEquals(expectedObjects.getFirst().getUuid(), actualObjects.getFirst().getUuid());
  }
}